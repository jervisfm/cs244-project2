...
\begin{figure}
  \centering
  \includegraphics[height=8cm]{./img/final_trace.png}
  \caption{Our algorithm on the Verizon Trace}
...
We call our approach \fbox{\texttt{Rocinante}}, named after the light, agile,
