...
After our first attempt, we decided build off of the delay-based algorithm from
...
naive RTT threshold, we now use feedback from the acknowledge packets to set
this threshold.
